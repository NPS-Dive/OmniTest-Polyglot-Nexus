...
// Package personpb is generated from shared/proto/person_service.proto
// (package omnitest.polyglot.nexus). Regenerate with scripts/generate.ps1
// or `make generate` after proto changes. The server imports these types only
